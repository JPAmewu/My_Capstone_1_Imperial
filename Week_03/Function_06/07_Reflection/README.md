# Week 03 Function 06 reflection

## Objective

Review Function 06 at the Week 3 checkpoint and decide what the
...
The latest verified return `-1.339542` did not exceed the incumbent `-0.7142649`. The verified incumbent occurs at query 1 with
...
Repeated UCB use showed that a plausible model recommendation still needs a returned value before it counts as progress. For Function 06, the result shows that a
