# Week 03 Function 02 reflection

## Objective

Review Function 02 at the Week 3 checkpoint and decide what the
...
The latest verified return `0.0486837` did not exceed the incumbent `0.6112052`. The verified incumbent occurs at query 10 with
...
Repeated UCB use showed that a plausible model recommendation still needs a returned value before it counts as progress. For Function 02, the result shows that a
