# Week 03 Function 03 reflection

## Objective

Review Function 03 at the Week 3 checkpoint and decide what the
...
The latest verified return `-0.1832388` did not exceed the incumbent `-0.03483531`. The verified incumbent occurs at query 4 with
...
Repeated UCB use showed that a plausible model recommendation still needs a returned value before it counts as progress. For Function 03, the result shows that a
