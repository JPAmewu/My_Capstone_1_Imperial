# Week 03 Function 08 reflection

## Objective

Review Function 08 at the Week 3 checkpoint and decide what the
...
all 43 cumulative observations, kept the
...
The latest verified return `8.963604` did not exceed the incumbent `9.939904`. The verified incumbent occurs at query 42 with
...
Repeated UCB use showed that a plausible model recommendation still needs a returned value before it counts as progress. For Function 08, the result shows that a
