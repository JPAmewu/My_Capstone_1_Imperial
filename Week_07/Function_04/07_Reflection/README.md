# Week 07 Function 04 reflection

## Objective

Review Function 04 at the Week 7 checkpoint and decide what the
...
The latest verified return `-20.19585` did not exceed the incumbent `-1.981075`. The verified incumbent occurs at query 33 with
...
Stronger exploitation did not reliably improve incumbents, demonstrating the risk of repeatedly searching one attractive basin. For Function 04, the result shows that a
