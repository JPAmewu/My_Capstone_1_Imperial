# Week 07 Function 08 reflection

## Objective

Review Function 08 at the Week 7 checkpoint and decide what the
...
all 47 cumulative observations, kept the
...
The latest verified return `8.563639` did not exceed the incumbent `9.939904`. The verified incumbent occurs at query 42 with
...
Stronger exploitation did not reliably improve incumbents, demonstrating the risk of repeatedly searching one attractive basin. For Function 08, the result shows that a
