# Week 10 Function 03 reflection

## Objective

Review Function 03 at the Week 10 checkpoint and decide what the
...
The latest verified return `-0.0463388` did not exceed the incumbent `-0.03483531`. The verified incumbent occurs at query 4 with
...
One transparent target-normalisation path made GP diagnostics easier to interpret and reproduce. For Function 03, the result shows that a
