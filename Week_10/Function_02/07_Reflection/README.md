# Week 10 Function 02 reflection

## Objective

Review Function 02 at the Week 10 checkpoint and decide what the
...
The latest verified return `0.02678837` did not exceed the incumbent `0.6112052`. The verified incumbent occurs at query 10 with
...
One transparent target-normalisation path made GP diagnostics easier to interpret and reproduce. For Function 02, the result shows that a
