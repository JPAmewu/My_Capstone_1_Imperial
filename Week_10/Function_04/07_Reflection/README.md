# Week 10 Function 04 reflection

## Objective

Review Function 04 at the Week 10 checkpoint and decide what the
...
The latest verified return `-15.12573` did not exceed the incumbent `-1.981075`. The verified incumbent occurs at query 33 with
...
One transparent target-normalisation path made GP diagnostics easier to interpret and reproduce. For Function 04, the result shows that a
