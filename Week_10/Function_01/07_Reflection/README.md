# Week 10 Function 01 reflection

## Objective

Review Function 01 at the Week 10 checkpoint and decide what the
...
The latest verified return `-4.592141e-89` did not exceed the incumbent `7.710875e-16`. The verified incumbent occurs at query 3 with
...
One transparent target-normalisation path made GP diagnostics easier to interpret and reproduce. For Function 01, the result shows that a
