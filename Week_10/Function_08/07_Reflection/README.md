# Week 10 Function 08 reflection

## Objective

Review Function 08 at the Week 10 checkpoint and decide what the
...
all 50 cumulative observations, kept the
...
The latest verified return `9.373668` did not exceed the incumbent `9.939904`. The verified incumbent occurs at query 42 with
...
One transparent target-normalisation path made GP diagnostics easier to interpret and reproduce. For Function 08, the result shows that a
