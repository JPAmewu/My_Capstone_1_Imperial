# Week 10 Function 07 reflection

## Objective

Review Function 07 at the Week 10 checkpoint and decide what the
...
all 40 cumulative observations, kept the
...
The latest verified return `0.8456374` did not exceed the incumbent `2.149905`. The verified incumbent occurs at query 33 with
...
One transparent target-normalisation path made GP diagnostics easier to interpret and reproduce. For Function 07, the result shows that a
