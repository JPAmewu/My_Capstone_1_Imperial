...
Weeks 1–10 contain the recoverable experiment history. The Week 11 notebook is
a corrected, executed corruption-aware review: it excludes untrusted local
arrays and generates eight proposals for Week 12. Those proposals are preserved
...
- Returned Week 5, Week 7, Week 8 and Week 10–13 query/output pairs are not
  preserved in the repository and are excluded rather than reconstructed.
...
- Week 12 has a genuine proposal file generated by the Week 11 workflow, but no
  returned outputs; the Week 12 and Week 13 notebooks remain placeholders.
