# Week 02 Function 06 reflection

## Objective

Review Function 06 at the Week 2 checkpoint and decide what the
...
The latest verified return `-0.8782406` did not exceed the incumbent `-0.7142649`. The verified incumbent occurs at query 1 with
...
Introducing a surrogate made uncertainty explicit and exposed the need for reproducible, function-specific random streams. For Function 06, the result shows that a
