# Week 02 Function 01 reflection

## Objective

Review Function 01 at the Week 2 checkpoint and decide what the
...
all 12 cumulative observations, kept the
...
The latest verified return `1.674933e-36` did not exceed the incumbent `7.710875e-16`. The verified incumbent occurs at query 3 with
...
Introducing a surrogate made uncertainty explicit and exposed the need for reproducible, function-specific random streams. For Function 01, the result shows that a
