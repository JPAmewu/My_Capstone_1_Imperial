# Week 02 Function 02 reflection

## Objective

Review Function 02 at the Week 2 checkpoint and decide what the
...
The latest verified return `0.02266663` did not exceed the incumbent `0.6112052`. The verified incumbent occurs at query 10 with
...
Introducing a surrogate made uncertainty explicit and exposed the need for reproducible, function-specific random streams. For Function 02, the result shows that a
