# Week 02 Function 04 reflection

## Objective

Review Function 04 at the Week 2 checkpoint and decide what the
...
The latest verified return `-31.73536` did not exceed the incumbent `-4.025542`. The verified incumbent occurs at query 28 with
...
Introducing a surrogate made uncertainty explicit and exposed the need for reproducible, function-specific random streams. For Function 04, the result shows that a
