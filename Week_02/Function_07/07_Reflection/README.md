# Week 02 Function 07 reflection

## Objective

Review Function 07 at the Week 2 checkpoint and decide what the
...
all 32 cumulative observations, kept the
...
The latest verified return `0.3087652` did not exceed the incumbent `1.364968`. The verified incumbent occurs at query 7 with
...
Introducing a surrogate made uncertainty explicit and exposed the need for reproducible, function-specific random streams. For Function 07, the result shows that a
