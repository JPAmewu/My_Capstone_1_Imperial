# Week 02 Function 03 methodology
...
At this review point, starter data and the Week 1 return are observed; the Week 2 GP-UCB query is proposed only. No value is imputed, and the proposal is excluded from observed arrays. Results are descriptive within Function 03.

## Reproduction

```bash
MPLBACKEND=Agg .venv/bin/python Week_02/Function_03/02_Code/analyse_week_02_function_03.py --write-artifacts
```
