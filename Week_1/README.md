Bayesian Optimisation,Grid search, Random search and Manual reasoning were the techniques used during week 1 for the optimisation process. Based on all the perfomance results of the various optimisation techniques that were applied during the first week, the strategy for the secon week will be as follows: 

PRIMARY CHOICE : Bayesian Optimisation will be the first choice for all the functions except for function 5 which produced the max. by the application of manual technique. The reasons for bayesian technique for week 2 is due to the following:                                   a)Strong performance
b)Consistent positive outputs
