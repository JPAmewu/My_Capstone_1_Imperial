# Week 04 Function 01 reflection

## Objective

Review Function 01 at the Week 4 checkpoint and decide what the
...
all 14 cumulative observations, kept the
...
The latest verified return `-2.466641e-107` did not exceed the incumbent `7.710875e-16`. The verified incumbent occurs at query 3 with
...
Repairing the evidence chain mattered as much as fitting the model; unverified rows could otherwise move the apparent incumbent. For Function 01, the result shows that a
