# Week 04 Function 03 reflection

## Objective

Review Function 03 at the Week 4 checkpoint and decide what the
...
The latest verified return `-0.0825135` did not exceed the incumbent `-0.03483531`. The verified incumbent occurs at query 4 with
...
Repairing the evidence chain mattered as much as fitting the model; unverified rows could otherwise move the apparent incumbent. For Function 03, the result shows that a
