"""Build the focused Function 05 notebook from the Week 1 baseline contract."""
...
def build(repository_root: Path) -> Path:
    ...
    output = repository_root / "Week_01/Function_05/01_Notebook/Week_01_Function_05.ipynb"
