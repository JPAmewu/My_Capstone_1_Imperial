# Week 05 Function 06 reflection

## Objective

Review Function 06 at the Week 5 checkpoint and decide what the
...
The latest verified return `-2.529369` did not exceed the incumbent `-0.7142649`. The verified incumbent occurs at query 1 with
...
Comparing UCB with Expected Improvement clarified that acquisition rules express different attitudes to improvement and uncertainty. For Function 06, the result shows that a
