# Week 05 Function 04 reflection

## Objective

Review Function 04 at the Week 5 checkpoint and decide what the
...
The latest verified return `-17.92631` did not exceed the incumbent `-1.981075`. The verified incumbent occurs at query 33 with
...
Comparing UCB with Expected Improvement clarified that acquisition rules express different attitudes to improvement and uncertainty. For Function 04, the result shows that a
