# Week 05 Function 05 reflection

## Objective

Review Function 05 at the Week 5 checkpoint and decide what the
verified evidence implies for the next optimisation step.

## Strategy and work completed

I used Expected Improvement within the Week 5 workflow. I validated
all 25 cumulative observations, kept the
...
The latest verified return `0.9401161` did not exceed the incumbent `1088.86`. The verified incumbent occurs at query 16 with
...
Comparing UCB with Expected Improvement clarified that acquisition rules express different attitudes to improvement and uncertainty. For Function 05, the result shows that a
