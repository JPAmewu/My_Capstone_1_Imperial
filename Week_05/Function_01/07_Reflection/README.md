# Week 05 Function 01 reflection

## Objective

Review Function 01 at the Week 5 checkpoint and decide what the
...
The latest verified return `7.65121e-239` did not exceed the incumbent `7.710875e-16`. The verified incumbent occurs at query 3 with
...
Comparing UCB with Expected Improvement clarified that acquisition rules express different attitudes to improvement and uncertainty. For Function 01, the result shows that a
