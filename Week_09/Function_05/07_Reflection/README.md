# Week 09 Function 05 reflection

## Objective

Review Function 05 at the Week 9 checkpoint and decide what the
...
The latest verified return `430.8031` did not exceed the incumbent `1465.512`. The verified incumbent occurs at query 28 with
...
Recovered rounds demonstrated that data lineage can change the modelling state; evidence must be reconciled before optimisation. For Function 05, the result shows that a
