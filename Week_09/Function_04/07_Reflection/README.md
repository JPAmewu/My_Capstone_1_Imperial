# Week 09 Function 04 reflection

## Objective

Review Function 04 at the Week 9 checkpoint and decide what the
...
The latest verified return `-23.4228` did not exceed the incumbent `-1.981075`. The verified incumbent occurs at query 33 with
...
Recovered rounds demonstrated that data lineage can change the modelling state; evidence must be reconciled before optimisation. For Function 04, the result shows that a
